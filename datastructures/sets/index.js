...
function mySet(){
    ...
    var collection=[]
    // has=> check for the presence of the element & returns true or false
    ...
    // this method will return the intersectoin of two sets
    ...
    // subset method will return if first set is subset of the other set
